...
#
#    **** WorldTrading Data is now Marketstack ****
#    **** https://marketstack.com/             ****
#
#    World Trading Data Stocks and Index
#    (c) 2019 Bruce Schuck <bschuck@asgard-systems.com>
#
...
{
    our @labels = qw/date isodate open high low close volume last currency/;
